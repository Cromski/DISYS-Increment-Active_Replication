...
func (c *incrementServiceClient) Increment(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Value, error) {
	out := new(Value)
...
func (UnimplementedIncrementServiceServer) Increment(context.Context, *Request) (*Value, error) {
